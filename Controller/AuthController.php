        ...
        try {
            ...
            echo json_encode([
                ...
                'user' => [
                    ...
                    'bio' => $user['bio'] ?? null,
                    'favorite_categories' => $user['favorite_categories'] ? json_decode($user['favorite_categories'], true) : [],
                    'favorite_marketplace_items' => $user['favorite_marketplace_items'] ? json_decode($user['favorite_marketplace_items'], true) : [],
                    'friends_list' => $user['friends_list'] ? json_decode($user['friends_list'], true) : [],
